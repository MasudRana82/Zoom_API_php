...
class Zoom_Api
{
	private $zoom_api_key = 'P2EwagIiRKerVShmTb2XEA';
	private $zoom_api_secret = 'YC1T99iXioGTCMokFi3qJ2jnkAryLNn8cPYq';	
	...
	//function to send request
    	...
    	{
		//Enter_Your_Email
		$request_url = "https://api.zoom.us/v2/users/robinctgpoly@gmail.com/meetings";
